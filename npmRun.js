...
_;
import { command_project, delay, divine, fsReadFileAsync, fsWriteFileAsync, getEnviromentVariables, killProcess, prompCommitMessageAndPush, successLog, zodCheckAndHandle } from './btr.js';
_;
if (command_project) {
    zodCheckAndHandle(zValidNpmCommand_project, command_project, npmRun_project, [command_project], divine.error);
}
