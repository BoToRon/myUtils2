...
_;
import { checkCodeThatCouldBeUpdated, colorLog, copyToClipboard_server, delay, divine, errorLog, fsReadFileAsync, fsWriteFileAsync, getCachedFiles, getFilesAndFoldersNames, inquirePromptCommands, killProcess, logEmptyLine, mapCommandsForInquirePrompt, questionAsPromise, selfFilter, successLog, transpileFiles, zodCheck_curry } from '../btr.js';
